...
export const competitiveLiveQuestions: LiveQuestionCatalogEntry[] = [
  ...
  defineLiveQuestion({
    id: 'live-mc-prioridade-prazo-curto',
    type: 'multiple_choice',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Prioridade',
    difficulty: 'medium',
    text: 'Voce tem pouco tempo para uma entrega. Qual atitude reduz mais o risco?',
    options: ['Confirmar prioridade e entregar por partes', 'Comecar pela parte mais facil sem avisar', 'Tentar fazer tudo ao mesmo tempo', 'Esperar alguem cobrar'],
    correctOptionText: 'Confirmar prioridade e entregar por partes',
    explanation: 'Quando o prazo e curto, alinhar prioridade e dividir a entrega evita retrabalho e surpresa.',
  }),
  defineLiveQuestion({
    id: 'live-mc-entrevista-exemplo',
    type: 'multiple_choice',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Entrevista',
    difficulty: 'medium',
    text: 'Em uma entrevista, qual resposta costuma ser mais forte?',
    options: ['Trazer um exemplo concreto do que aprendeu', 'Dizer apenas que aprende rapido', 'Responder tudo com uma palavra', 'Falar mal de experiencias anteriores'],
    correctOptionText: 'Trazer um exemplo concreto do que aprendeu',
    explanation: 'Exemplos concretos mostram comportamento, contexto e aprendizado de forma mais confiavel.',
  }),
  defineLiveQuestion({
    id: 'live-mc-senha-trabalho',
    type: 'multiple_choice',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Seguranca digital',
    difficulty: 'easy',
    text: 'Se alguem pedir sua senha de sistema, a resposta correta e:',
    options: ['Nao compartilhar e procurar o canal responsavel', 'Enviar por mensagem privada', 'Emprestar so por alguns minutos', 'Anotar em papel para facilitar'],
    correctOptionText: 'Nao compartilhar e procurar o canal responsavel',
    explanation: 'Senha e pessoal. Compartilhar acesso cria risco para a empresa e para a propria pessoa.',
  }),
  defineLiveQuestion({
    id: 'live-tf-assinar-sem-ler',
    type: 'true_false',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Documentos',
    difficulty: 'easy',
    text: 'E uma boa pratica assinar qualquer documento rapidamente para nao atrasar o processo.',
    options: ['Verdadeiro', 'Falso'],
    correctOptionText: 'Falso',
    explanation: 'Documentos devem ser lidos e duvidas precisam ser esclarecidas antes da assinatura.',
  }),
  defineLiveQuestion({
    id: 'live-tf-duvida-tarefa',
    type: 'true_false',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Pedir ajuda',
    difficulty: 'easy',
    text: 'Pedir esclarecimento quando a tarefa esta confusa pode evitar retrabalho.',
    options: ['Verdadeiro', 'Falso'],
    correctOptionText: 'Verdadeiro',
    explanation: 'Perguntar bem antes de executar economiza tempo e melhora a entrega.',
  }),
  defineLiveQuestion({
    id: 'live-ms-mensagem-profissional',
    type: 'multiple_select',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Comunicacao',
    difficulty: 'medium',
    text: 'Quais elementos ajudam uma mensagem profissional a ser entendida?',
    options: ['Contexto do pedido', 'Prazo ou urgencia', 'Proximo passo esperado', 'Varias abreviacoes internas sem explicar'],
    correctOptionTexts: ['Contexto do pedido', 'Prazo ou urgencia', 'Proximo passo esperado'],
    explanation: 'Mensagem boa explica contexto, prazo e acao esperada sem criar ambiguidades.',
  }),
  defineLiveQuestion({
    id: 'live-ms-reuniao-produtiva',
    type: 'multiple_select',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Organizacao',
    difficulty: 'medium',
    text: 'Quais atitudes ajudam depois de uma reuniao com combinados?',
    options: ['Registrar responsaveis', 'Confirmar prazos', 'Anotar proximos passos', 'Confiar apenas na memoria de todos'],
    correctOptionTexts: ['Registrar responsaveis', 'Confirmar prazos', 'Anotar proximos passos'],
    explanation: 'Combinados viram entrega quando responsaveis, prazos e proximos passos ficam claros.',
  }),
  defineLiveQuestion({
    id: 'live-ms-postura-cliente',
    type: 'multiple_select',
    bucket: 'competitive',
    tone: 'objective',
    sessionFit: 'competition',
    topic: 'Atendimento',
    difficulty: 'medium',
    text: 'Quais atitudes ajudam em um atendimento com pessoa irritada?',
    options: ['Manter calma', 'Entender o problema antes de responder', 'Indicar o proximo passo', 'Responder no mesmo tom da pessoa'],
    correctOptionTexts: ['Manter calma', 'Entender o problema antes de responder', 'Indicar o proximo passo'],
    explanation: 'Atendimento profissional reduz tensao, busca dados e mostra caminho de solucao.',
  }),
];
